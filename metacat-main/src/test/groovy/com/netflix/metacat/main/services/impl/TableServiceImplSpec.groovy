...
class TableServiceImplSpec extends Specification {
    ...
    def setup() {
        ...
        usermetadataService.getDefinitionMetadataWithParameters(_,_) >> Optional.empty()
    ...
    def testTableGet() {
        ...
        service.get(name,GetTableServiceParameters.builder().
            ...
            .build())
        then:
        1 * usermetadataService.getDefinitionMetadataWithParameters(_,_) >> Optional.empty()
        ...
        1 * usermetadataService.getDataMetadata(_) >> Optional.empty()
        0 * usermetadataService.getDefinitionMetadataWithParameters(_,_) >> Optional.empty()
