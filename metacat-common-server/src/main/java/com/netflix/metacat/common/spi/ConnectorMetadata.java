...
public interface ConnectorMetadata {
     ...
     */
    ConnectorTableMetadata alterTable(ConnectorSession session, ConnectorTableMetadata tableMetadata);
    ...
    /**
     * Return the metadata for the specified table name.
     *
     * @throws RuntimeException if table is no longer valid
     */
